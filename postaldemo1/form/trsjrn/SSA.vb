...
Public Class SSA
    ...
    Private Sub SSA_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub SSA_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        waitopen()
        ssalist.MdiParent = mainfrm
        ssalist.WindowState = FormWindowState.Normal
        ssalist.Show()
        ssalist.GetData()
        ssalist.filt()
        btnSave.Enabled = False
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        waitopen() : UserAc.gropbox2.Enabled = False
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            con.Open()
            Dim cb As String
            cb = "insert into SSAC(ACNO,Name,Depositer,today,BBT,Transtype,Amount,fine,balance,m_onth,DLT,Notes)VALUES('" & account_no.Text & "','" & AccountHolderName.Text & "','" & NameOfDepositer.Text & "','" & to_date.Text & "','" & Accountbal.Text & "','" & transtype.ToString & "','" & tranfamt.Text & "','" & TextBox1.Text & "','" & BalAfterTrans.Text & "','" & TextBox2.Text & "','" & DLT.Text & "','" & Remark.Text.ToString & "')"
            ...
            con = New OleDbConnection(cs)
            con.Open()
            Dim cb3 As String = "insert into CMB(ACNO,Name,acType,today,Transtype,Amount,fine,Notes)VALUES('" & account_no.Text & "','" & AccountHolderName.Text & "','SS Account','" & to_date.Text & "','" & transtype.ToString & "','" & tranfamt.Text & "','" & TextBox1.Text & "','" & Remark.Text.ToString & "')"
            'Dim cb3 As String = "insert into CMB(ACNO,Name,Depositer,acType,today,BBT,Transtype,Amount,fine,balance,m_onth,DNT,DLT,Notes)VALUES('" & account_no.Text & "','" & AccountHolderName.Text & "','" & NameOfDepositer.Text & "','Saving Account','" & to_date.Text & "','" & Accountbal.Text & "','" & transtype.ToString & "','" & tranfamt.Text & "','00','" & BalAfterTrans.Text & "','N/a','" & DNT.Text & "','" & DLT.Text & "','" & Remark.Text.ToString & "')"
            ...
            con = New OleDbConnection(cs)
            con.Open()
            Dim cb4 As String = "insert into transdetail(d_ate,AccountType,accountNumber,AccountHolderName,deposit,withdrow,balance,DLT,remark)VALUES('" & to_date.Text & "','SS Account','" & account_no.Text & "','" & AccountHolderName.Text & "','" & af.ToString & "','00','" & BalAfterTrans.Text & "','" & DLT.Text & "','" & TextBox2.Text + Remark.Text.ToString & "')"

            Dim cb5 As String = "insert into transdetail(d_ate,AccountType,accountNumber,AccountHolderName,withdrow,deposit,balance,DLT,remark)VALUES('" & to_date.Text & "','SS Account','" & account_no.Text & "','" & AccountHolderName.Text & "','" & af.ToString & "','00','" & BalAfterTrans.Text & "','" & DLT.Text & "','" & TextBox2.Text + Remark.Text.ToString & "')"
        ...
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
        btnSave.Enabled = False : waitclose()
    End Sub
    ...
    Sub pressentr()
        ...
        Try
            ...
            Dim dr As DataGridViewRow = ssalist.DataGridView1.Rows(0)
            '  Me.Hide()
            '  rdac.Hide()
            ...
            '*********************************************************************
            Dim dr1 As DataGridViewRow = ssalist.DataGridView2.Rows(0)
