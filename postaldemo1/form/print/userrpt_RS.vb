...
Public Class userrpt_RS
    ...
    End Sub
    Public Sub GetintDatausrrpt_RS(ByVal data As List(Of Cls_RS_userdetails))
        ObjectDataSource1.DataSource = data
    End Sub

    Private Sub userrpt_RS_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles Me.BeforePrint
