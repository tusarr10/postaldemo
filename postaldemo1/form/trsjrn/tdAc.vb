...
Public Class tdAc
    ...
    Private Sub tdAc_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub tdAc_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            con.Open()
            Dim cb As String
            cb = "insert into td_ac(AcNo,CustmorName,depositerName,todate,BBT,transType,transAmt,DNT,DLT,Notes,AcBal)VALUES('" & account_no.Text & "','" & AccountHolderName.Text & "','" & NameOfDepositer.Text & "','" & to_date.Text & "','" & Accountbal.Text & "','" & transtype.ToString & "','" & tranfamt.Text & "','" & DNT.Text & "','" & DLT.Text & "','" & Remark.Text.ToString & "','" & BalAfterTrans.Text & "')"
            ...
            con = New OleDbConnection(cs)
            con.Open()
            Dim cb3 As String = "insert into CMB(ACNO,Name,acType,today,Transtype,Amount,fine,Notes)VALUES('" & account_no.Text & "','" & AccountHolderName.Text & "','Time Deposit','" & to_date.Text & "','" & transtype.ToString & "','" & tranfamt.Text & "','00','" & Remark.Text.ToString & "')"
            ...
            '**********************************END********************************************************
            ''''''''''''''******************************************update in trans details *********************
            con = New OleDbConnection(cs)
            con.Open()
            Dim cb4 As String = "insert into transdetail(d_ate,AccountType,accountNumber,AccountHolderName,deposit,withdrow,balance,DLT,remark)VALUES('" & to_date.Text & "','Time Deposit','" & account_no.Text & "','" & AccountHolderName.Text & "','" & tranfamt.Text & "','00','" & BalAfterTrans.Text & "','" & DLT.Text & "','" & Remark.Text.ToString & "')"

            Dim cb5 As String = "insert into transdetail(d_ate,AccountType,accountNumber,AccountHolderName,withdrow,deposit,balance,DLT,remark)VALUES('" & to_date.Text & "','Time Deposit','" & account_no.Text & "','" & AccountHolderName.Text & "','" & tranfamt.Text & "','00','" & BalAfterTrans.Text & "','" & DLT.Text & "','" & Remark.Text.ToString & "')"
    ...
    End Sub
    Sub pressentr()
        tdlist.MdiParent = mainfrm
        tdlist.WindowState = FormWindowState.Normal
        ' tdlist.Show()
        'tdlist.GetData()
        tdlist.filt()
        Try
            Dim dr As DataGridViewRow = tdlist.DataGridView1.SelectedRows(0)
            '  Me.Hide()
            '  SBAc.Hide()
            ...
            Dim dr1 As DataGridViewRow = tdlist.DataGridView2.Rows(0)
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        ACBAL.Text = Accountbal.Text : waitclose()
    End Sub
