Public Class printmain 
    ...
    Public Sub print_myworkload(ByVal d_ate As String, ByVal y_ear As String, ByVal boname As String, ByVal soname As String, ByVal ho As String, ByVal bh As String, ByVal tw As String, ByVal deg As String, ByVal plv As String) ' For Workload .
        waitopen()
        Dim report As report1 = New report1
        '   report.getinfo(d_ate, y_ear, boname, soname, ho, bh, tw, deg, plv)
        report.getinfo1()
        report.wc1()
        report.wcost()
        DocumentViewer1.DocumentSource = report
